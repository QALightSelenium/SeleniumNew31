...
import static org.hamcrest.CoreMatchers.is;
    ...
    public class ParentTest {
        ...
        public AparatPage aparatPage;
        public SlovarPage slovaryPage;
        public ParentPage parentPage;

        private Utils utils = new Utils();              //screenShot
        ...
        @Rule                   //достучатися до імя нашого класу
...
//                {"remote"}
        ...
        @Before
        public void setUp() {                                           //name for screen Shot
            pathToScreenShot = "..\\SviridenkoProj\\target\\screenshot\\" + this.getClass().getPackage().getName() + "\\" +
            ...
            aparatPage = new AparatPage(driver);
            slovaryPage = new SlovarPage(driver);
        ...
        protected void checkAcceptanceCriteria(String message, String actual, String expected){
            if (!actual.equals(expected)) {
                utils.screenShot(pathToScreenShot, driver);
            }                           //  можуть інші предикати замість 'is'
            Assert.assertThat(message, actual, is (expected));
            isTestPass = true;
